...
The removed blocks are implemented as postprocessing steps.
...
But the output is group that most of the accuracy can be made better by adjusting the threshold.
In %\cref{}
